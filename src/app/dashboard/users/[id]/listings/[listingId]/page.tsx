...
export default function AdminListingDetailPage({
  ...
  const property = getDemoProperty(listingId);
  ...
  return (
    <div className="flex flex-col" style={{ gap: 24 }}>
            ...
            <div className="flex items-center flex-wrap" style={{ gap: 16 }}>
              ...
              <div className="flex items-center" style={{ gap: 12 }}>
                ...
                <div className="flex items-center" style={{ gap: 8 }}>
                  <span style={{ fontSize: 14, fontWeight: 600, color: "#121212" }}>{listing.seller.name}</span>
                  <Image src="/icons/dash/verify.svg" alt="" width={20} height={20} />
                  <span className="rounded-[16px]" style={{ background: "rgba(220,142,29,0.08)", color: "#DC8E1D", fontSize: 12, fontWeight: 500, lineHeight: "18px", padding: "2px 12px" }}>Owner</span>
                </div>
              </div>
              {/* Location */}
              <div className="flex items-center" style={{ gap: 8 }}>
      ...
      <div className="flex flex-col" style={{ gap: 32 }}>
        ...
        <PriceSpecs price={listing.price} sqft={listing.sqft} beds={listing.beds} baths={listing.baths} />
...
/* ── Price + specs, between two full-width dividers ── */
...
/* ── View Map: OSM embed + Map/Satellite toggle + maximize ── */
